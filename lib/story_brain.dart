...
class StoryBrain {
  ...
  String getStory() {
    return _storyData[qNum].storyTitle;
  }

  String getChoice1() {
    return _storyData[qNum].choice1;
  }

  String getChoice2() {
    return _storyData[qNum].choice2;
  }
  ...
  void nextStory(int choice) {
    if (qNum == 0 && choice == 1) {
      qNum = 2;
      count++;
    } else if (count == 0 && choice == 2) {
      qNum = 1;
      count++;
    } else if (count == 1 && choice == 1 && qNum == 2) {
      qNum = 5;
      count++;
    } else if (count == 1 && choice == 2 && qNum == 2) {
      qNum = 4;
      count++;
    } else if (count == 1 && choice == 1 && qNum == 1) {
      qNum = 2;
      count++;
    } else if (count == 1 && choice == 2 && qNum == 1) {
      qNum = 3;
      count++;
    } else if (count == 2 && choice == 1 && qNum == 2) {
      qNum = 5;
      count++;
    } else if (count == 2 && choice == 2 && qNum == 2) {
      qNum = 4;
      count++;
    } else if (qNum == 3 || qNum == 4 || qNum == 5) restart();
  }

  bool buttonVisibility() {
    if (qNum == 0 || qNum == 1 || qNum == 2)
      return true;
    else {
      return false;
    }
